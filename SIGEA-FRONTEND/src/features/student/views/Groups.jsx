...
import { HiCalendar, HiChevronRight, HiUser } from 'react-icons/hi';
...
export default function Groups() {
    ...
    const getCurriculumDuration = (curriculum) => {
        ...
        const totalWeeks = curriculum.modules.reduce((acc, module) => {
            const moduleWeeks = module.subjects?.reduce((subAcc, subject) => {
                        ...
                        try {
                            ...
                            if (curriculum?.modules && curriculum.modules.length > 0) {
                                for (let i = 0; i < curriculum.modules.length; i++) {
                                    const moduleWeeks = curriculum.modules[i].subjects?.reduce((acc, subject) =>
                                        acc + (subject.weeks || 0), 0) || 0;
                            ...
                            const progress = durationData.totalModules > 0 ?
                                Math.round((completedModules / durationData.totalModules) * 100) : 0;
    ...
    return (
        <>
            <div className="bg-white rounded-top p-2 p-md-3">
                ...
                <div className='row mt-2 mt-md-3 gx-2 gx-md-3'>
                    {loading ? (
                        ...
                        enrollments.map((enrollment, index) => (
                            <motion.div
                                key={enrollment.id}
                                className="col-12 col-sm-6 col-lg-4 col-xl-3 mb-3 mb-md-4"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="card-header bg-gradient p-2 p-md-3" style={{
                                        ...
                                        <div className="d-flex align-items-center justify-content-between text-white">
                                            ...
                                            <HiChevronRight size={18} className="d-md-none" />
                                            <HiChevronRight size={20} className="d-none d-md-block" />
                                        </div>
                                    </div>
                                    ...
                                    <div className='card-body p-2 p-md-4 pb-3'>
                                        ...
                                        <div className="mb-2 mb-md-3">
                                            ...
                                            <div className="d-flex align-items-center text-muted">
                                                <HiCalendar className="me-2 flex-shrink-0" size={14} />
                                        ...
                                        <div className="mb-2 mb-md-3">
                                            <div className="d-flex justify-content-between align-items-center mb-1 mb-md-2">
                                                ...
                                                <span className={`badge bg-${getProgressColor(enrollment.progress)} small`}>
                                                    {enrollment.progress}%
                                                </span>
                                            </div>
                                            ...
                                            <div className="d-flex flex-column flex-md-row justify-content-between">
                                                ...
                                                <small className="text-primary fw-medium">
                                                    Módulo actual: {enrollment.currentModule}
                                                </small>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-auto">
                                            <div className="d-flex align-items-center justify-content-center p-2 p-md-3 rounded bg-light">
                                                <BiSolidBookBookmark className="text-primary me-2 flex-shrink-0" size={16} />
