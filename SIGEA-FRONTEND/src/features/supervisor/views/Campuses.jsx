...
export default function Campuses() {
    ...
    const loadCareersCount = useCallback(async (campusList) => {
        ...
        try {
            ...
            setCampusWithCareers(campusList.map(campus => ({
                ...campus,
                careersCount: 0,
                careers: []
            })));
        ...
        return (
            <>
                <div className="bg-white rounded-top p-2">
                    <h3 className="text-blue-500 fw-semibold mx-3 my-1">Campus</h3>
                </div>
                                    ...
                                    <div className="d-flex justify-content-between align-items-start">
                                        <div className="flex-grow-1">
                                            <div className="d-flex align-items-center gap-2 mb-2">
                                                <h6 className="fw-semibold lh-sm mb-0 text-dark text-truncate">
                                                    {campus.name}
                                                </h6>
                                            </div>
                                        ...
                                        <div className="p-3 rounded bg-light">
                                            ...
                                            <div className="fw-bold text-secondary fs-4">
                                                {loadingCareers ? (
                                                    ...
                                                    campus.careersCount || 0
                                                )}
                                            </div>
                                            <small className="text-muted">
                                                {campus.careersCount === 1 ? 'Carrera' : 'Carreras'}
                                            </small>
                                        </div>
                                    </div>
                                </div>
